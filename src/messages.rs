...
pub const GET_LOCAL_BOOLEAN_ERROR: &'static str = "Get boolean local variable failed";
pub const GET_LOCAL_BYTE_ERROR: &'static str = "Get byte local variable failed";
pub const GET_LOCAL_CHAR_ERROR: &'static str = "Get char local variable failed";
pub const GET_LOCAL_SHORT_ERROR: &'static str = "Get short local variable failed";
